...
"")
        ...
        self.grpReports.setMinimumSize(QtCore.QSize(300, 0))
        self.grpReports.setMaximumSize(QtCore.QSize(300, 16777215))
...
"}")
        ...
        self.chk_scap_ckl_issues = QtWidgets.QCheckBox(self.grpReports)
        self.chk_scap_ckl_issues.setGeometry(QtCore.QRect(170, 20, 121, 17))
        self.chk_scap_ckl_issues.setChecked(True)
        self.chk_scap_ckl_issues.setObjectName("chk_scap_ckl_issues")
        self.chk_test_plan = QtWidgets.QCheckBox(self.grpReports)
        self.chk_test_plan.setGeometry(QtCore.QRect(170, 100, 70, 17))
        self.chk_test_plan.setChecked(True)
        self.chk_test_plan.setObjectName("chk_test_plan")
        self.chk_poam = QtWidgets.QCheckBox(self.grpReports)
        self.chk_poam.setGeometry(QtCore.QRect(10, 200, 70, 17))
        self.chk_poam.setChecked(True)
        self.chk_poam.setObjectName("chk_poam")
        self.chk_rar = QtWidgets.QCheckBox(self.grpReports)
        self.chk_rar.setGeometry(QtCore.QRect(10, 240, 70, 17))
        self.chk_rar.setChecked(True)
        self.chk_rar.setObjectName("chk_rar")
        self.chk_automated_scan_info = QtWidgets.QCheckBox(self.grpReports)
        self.chk_automated_scan_info.setGeometry(QtCore.QRect(10, 80, 161, 17))
        self.chk_automated_scan_info.setChecked(True)
        self.chk_automated_scan_info.setObjectName("chk_automated_scan_info")
        self.chk_software_linux = QtWidgets.QCheckBox(self.grpReports)
        self.chk_software_linux.setGeometry(QtCore.QRect(170, 40, 161, 17))
        self.chk_software_linux.setChecked(True)
        self.chk_software_linux.setObjectName("chk_software_linux")
        self.chk_software_windows = QtWidgets.QCheckBox(self.grpReports)
        self.chk_software_windows.setGeometry(QtCore.QRect(170, 60, 161, 17))
        self.chk_software_windows.setChecked(True)
        self.chk_software_windows.setObjectName("chk_software_windows")
        self.chk_asset_traceabilitiy = QtWidgets.QCheckBox(self.grpReports)
        self.chk_asset_traceabilitiy.setGeometry(QtCore.QRect(10, 60, 141, 17))
        self.chk_asset_traceabilitiy.setChecked(True)
        self.chk_asset_traceabilitiy.setObjectName("chk_asset_traceabilitiy")
        self.chk_hardware = QtWidgets.QCheckBox(self.grpReports)
        self.chk_hardware.setGeometry(QtCore.QRect(10, 120, 70, 17))
        self.chk_hardware.setChecked(True)
        self.chk_hardware.setObjectName("chk_hardware")
        self.chk_ppsm = QtWidgets.QCheckBox(self.grpReports)
        self.chk_ppsm.setGeometry(QtCore.QRect(10, 220, 70, 17))
        self.chk_ppsm.setChecked(True)
        self.chk_ppsm.setObjectName("chk_ppsm")
        self.chk_cci = QtWidgets.QCheckBox(self.grpReports)
        self.chk_cci.setGeometry(QtCore.QRect(10, 100, 70, 17))
        self.chk_cci.setChecked(True)
        self.chk_cci.setObjectName("chk_cci")
        self.chk_acas_unique_vuln = QtWidgets.QCheckBox(self.grpReports)
        self.chk_acas_unique_vuln.setGeometry(QtCore.QRect(10, 40, 141, 17))
        self.chk_acas_unique_vuln.setChecked(True)
        self.chk_acas_unique_vuln.setObjectName("chk_acas_unique_vuln")
        self.chk_acas_unique_iavm = QtWidgets.QCheckBox(self.grpReports)
        self.chk_acas_unique_iavm.setGeometry(QtCore.QRect(10, 20, 121, 17))
        self.chk_acas_unique_iavm.setAutoFillBackground(False)
        self.chk_acas_unique_iavm.setChecked(True)
        self.chk_acas_unique_iavm.setObjectName("chk_acas_unique_iavm")
        self.chk_missing_patches = QtWidgets.QCheckBox(self.grpReports)
        self.chk_missing_patches.setGeometry(QtCore.QRect(10, 160, 121, 17))
        self.chk_missing_patches.setChecked(True)
        self.chk_missing_patches.setObjectName("chk_missing_patches")
        self.chk_summary = QtWidgets.QCheckBox(self.grpReports)
        self.chk_summary.setGeometry(QtCore.QRect(170, 80, 70, 17))
        self.chk_summary.setChecked(True)
        self.chk_summary.setObjectName("chk_summary")
        self.chk_raw_data = QtWidgets.QCheckBox(self.grpReports)
        self.chk_raw_data.setGeometry(QtCore.QRect(10, 260, 70, 17))
        self.chk_raw_data.setChecked(True)
        self.chk_raw_data.setObjectName("chk_raw_data")
        self.chk_operating_systems = QtWidgets.QCheckBox(self.grpReports)
        self.chk_operating_systems.setGeometry(QtCore.QRect(10, 180, 141, 17))
        self.chk_operating_systems.setChecked(True)
        self.chk_operating_systems.setObjectName("chk_operating_systems")
        self.chk_local_users = QtWidgets.QCheckBox(self.grpReports)
        self.chk_local_users.setGeometry(QtCore.QRect(10, 140, 111, 17))
        self.chk_local_users.setChecked(True)
...
"}")
        ...
        ScansToReports.setTabOrder(self.txt_email, self.chkSkipInfo)
        ...
        ScansToReports.setTabOrder(self.chk_prefill_scd, self.spnExcludeDays)
        ScansToReports.setTabOrder(self.spnExcludeDays, self.chk_acas_unique_iavm)
        ScansToReports.setTabOrder(self.chk_acas_unique_iavm, self.chk_acas_unique_vuln)
        ScansToReports.setTabOrder(self.chk_acas_unique_vuln, self.chk_asset_traceabilitiy)
        ScansToReports.setTabOrder(self.chk_asset_traceabilitiy, self.chk_automated_scan_info)
        ScansToReports.setTabOrder(self.chk_automated_scan_info, self.chk_cci)
        ScansToReports.setTabOrder(self.chk_cci, self.chk_hardware)
        ScansToReports.setTabOrder(self.chk_hardware, self.chk_local_users)
        ScansToReports.setTabOrder(self.chk_local_users, self.chk_missing_patches)
        ScansToReports.setTabOrder(self.chk_missing_patches, self.chk_operating_systems)
        ScansToReports.setTabOrder(self.chk_operating_systems, self.chk_poam)
        ScansToReports.setTabOrder(self.chk_poam, self.chk_ppsm)
        ScansToReports.setTabOrder(self.chk_ppsm, self.chk_rar)
        ScansToReports.setTabOrder(self.chk_rar, self.chk_raw_data)
        ScansToReports.setTabOrder(self.chk_raw_data, self.chk_scap_ckl_issues)
        ScansToReports.setTabOrder(self.chk_scap_ckl_issues, self.chk_software_linux)
        ScansToReports.setTabOrder(self.chk_software_linux, self.chk_software_windows)
        ScansToReports.setTabOrder(self.chk_software_windows, self.chk_summary)
        ScansToReports.setTabOrder(self.chk_summary, self.chk_test_plan)
        ScansToReports.setTabOrder(self.chk_test_plan, self.btn_select_scan_files)
